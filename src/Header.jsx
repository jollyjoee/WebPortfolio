...
function Header() {
  ...
  return (
    <header className={`fixed top-2 left-4 right-4 inset-x-0 max-w-auto md:max-w-4xl mx-auto w-auto shadow-2xl z-50 transition-all duration-575 ${scrolled ? "bg-black/30 scale-[1.04] md:scale-[1.1] rounded-b-4xl" : "bg-black/90 rounded-xl"}`}>
